...
const MOVE_SPEED := 80.0  # px/s horizontal movement while controllable
const TURN_SPEED := 5.0   # rad/s angular velocity while controllable
const X_LIMIT := 600.0    # half-width limit for clamping x position
